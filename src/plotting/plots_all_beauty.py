...
if __name__ == "__main__":
    # Carichiamo i dati
    json_path = os.path.join(PROJECT_ROOT, "datasets", "All_Beauty_f.jsonl")
    ...
    plot_embedding_projection(train_ds, PLOTS_DIR, cache_path, sample_size=302977)
    plot_embedding_projection_3D(train_ds, PLOTS_DIR, cache_path, sample_size=302977)
