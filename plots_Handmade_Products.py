...
PLOTS_DIR = os.path.join(THIS_PATH, "new_plots")
...
if __name__ == "__main__":
    ...
    plot_embedding_projection(train_ds, sample_size=149851)
    plot_embedding_projection_3D(train_ds, sample_size=149851)
